...
import { Menu as MenuImg, Send, Share, Info, Instagram, SunMoon } from "lucide-react"
    ...
    <div>
      ...
      <Sheet>
        ...
        <SheetContent className="bg-black/30 dark:bg-zinc-950/30 border-l border-l-gray-600">
          ...
          <div className='flex bg-gray-900 dark:bg-zinc-950/80 shadow-xl mx-10 p-2 border border-zinc-700 rounded-lg text-white text-center hover:underline will-change-auto' onClick={() => {
            console.log(theme)
            if (theme === "light") { setTheme("dark")
             } else { setTheme("light") }
          }}><SunMoon></SunMoon><p className='mx-auto'>テーマを切り替える</p>
          </div>
